...
for index, row in planet_df_1.iterrows():
    ...
    print(f"Coleta de dados do hyoerlink {index+1} concluída")
...
headers = ["planet_type", "discovery_date", "mass", "planet_radius", "orbital_radius", "orbital_radius","orbital_period","eccentricity","detection_method"]
